...
//     const navigation = useNavigation<VerificationScreenNavigationProp>( { route: { params: { email: string } } } );
...
//             console.log('Forgot Password successful, setting authenticated state');
